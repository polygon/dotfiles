...
{ config, pkgs, unstable, secrets, ... }:
{
  ...
  systemd.network = {
    ...
    networks."lan" = {
      matchConfig.MACAddress = "ba:da:55:03:00:00";
      addresses = [ { 
        addressConfig.Address = "192.168.1.24/24";
      } ];
      networkConfig = {
        Gateway = "192.168.1.1";
        DNS = "192.168.1.1";
    ...
    networks."server" = {
      matchConfig.MACAddress = "ba:da:55:03:00:01";
      addresses = [ { 
        addressConfig.Address = "192.168.3.24/24";
      } ];
    };
  };
